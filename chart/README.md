...
| `webhookCert.image.repository` | Certificate generator/patcher image repository | `ghcr.io/jkroepke/kube-webhook-certgen` |
| `webhookCert.image.tag` | Certificate generator/patcher image tag | `1.8.3` |
